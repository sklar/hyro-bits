...
`;var I=({bleed:r=!0,className:c,reverse:p,style:t,theme:o,vertical:y,...k})=>{let[T,z]=f(k,["data-hover","data-qa"]);return R("div",{...T,className:c,css:n,"data-bleed":r,"data-direction":y?"vertical":"horizontal","data-reverse":p||null,"data-theme":o||null,style:t},R(S,{...z,css:l,reverse:p,vertical:y}))};export{I as Range,g as dot,b as handle,m as mark,u as rail,l as slider,v as step,x as track,n as wrapper};
