...
`;var ot=(0,tt.forwardRef)((vt,it)=>{var B=vt,{active:t,as:e,busy:a,children:n,disabled:s,icon:b,placement:_,round:$,size:O="md",synthetic:R,text:u,theme:K,toggle:et,type:at="button",variant:rt="secondary"}=B,nt=A(B,["active","as","busy","children","disabled","icon","placement","round","size","synthetic","text","theme","toggle","type","variant"]);let[G,U]=Array.isArray(b)?b:[b],C=e===void 0||e==="button",dt={"data-qa":[`${C?"button":"link"}`,...u?[`${(0,Z.kebabCase)(u)}`]:[]].join("-")};return(0,Y.jsx)(e||"button",c(c({css:[S,E[O],f[rt]],"data-active":t||null,"data-busy":a||null,"data-icon":b&&!(u||n)&&"single"||G&&U&&"both"||_,"data-round":$||null,"data-synthetic":R||null,"data-theme":K||null,"data-toggle":et||null,disabled:C&&(a||s)?!0:void 0,ref:it,type:C?at:void 0},dt),nt),G,u||n,U,a&&(0,Y.jsx)(z,{style:{["--color"]:"var(--button-color)",position:"absolute"}}))});module.exports=pt(Rt);0&&(module.exports={Button,button,sizes,variants});
